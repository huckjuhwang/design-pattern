...
public class Client {
    public static void main(String[] args) {
        SortEngine sortEngineAdapter = new SortEngineAdapter(new SortAEngine(), new SortBEngine());

        sortEngineAdapter.sort();
        sortEngineAdapter.reverseSort();
        sortEngineAdapter.toPrettyPrint();
    }
}
